...
contract NonTransferableERC1155 is ERC1155, Ownable {
    ...
    function approveTransfer(address approvedAddress, bool approval) public onlyOwner {
    ...
    function safeTransferFrom(address from, address to, uint256 id, uint256 value, bytes memory data) public virtual override {
        address sender = _msgSender();
        require(
            from == address(0) || _approvedTransfer[sender] || sender == owner(),
